...
class Block(object):
    ...
    def create(dev_config: DevConfig,
        ...
        txs_hash = merkle_tx_hash(hashedtransactions)  # FIpurE: Find a better name, type changes
    ...
    def get_block_number_mapping(state: State, block_number: int):
        try:
            ...
            block_number_mapping = pur_pb2.BlockNumberMapping()
