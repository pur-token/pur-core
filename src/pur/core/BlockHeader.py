...
from pypurlib.pypurlib import shake128, bin2hstr

from pur.core.config import DevConfig, user as user_config
from pur.core.formulas import block_reward
...
class BlockHeader(object):
    def __init__(self, protobuf_blockheader=None):
        ...
        if protobuf_blockheader is None:
            self._data = pur_pb2.BlockHeader()
