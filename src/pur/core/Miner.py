...
from pur.core.miners.qryptonight7.CNv1Miner import CNv1Miner
from pur.core.miners.qrandomx.QRpuriner import QRandompuriner
...
class Miner:
    def __init__(self,
        ...
        self.qrandomx_miner = QRandompuriner(chain_manager,
                                            pre_block_logic,
                                            mining_address,
                                            mining_thread_count,
                                            self.lock)
