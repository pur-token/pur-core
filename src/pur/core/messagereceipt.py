...
from pur.generated.purlegacy_pb2 import LegacyMessage


# FIpurE: Refactor / improve
class MessageReceipt(object):
    ...
    services_arg = {
        ######################
        purlegacy_pb2.LegacyMessage.VE: 'veData',
        purlegacy_pb2.LegacyMessage.PL: 'plData',
        purlegacy_pb2.LegacyMessage.PONG: 'pongData',

        ######################
        purlegacy_pb2.LegacyMessage.MR: 'mrData',
        purlegacy_pb2.LegacyMessage.SFM: 'mrData',

        purlegacy_pb2.LegacyMessage.BK: 'block',
        purlegacy_pb2.LegacyMessage.FB: 'fbData',
        purlegacy_pb2.LegacyMessage.PB: 'pbData',

        ############################
        purlegacy_pb2.LegacyMessage.TX: 'txData',
        purlegacy_pb2.LegacyMessage.MT: 'mtData',
        purlegacy_pb2.LegacyMessage.TK: 'tkData',
        purlegacy_pb2.LegacyMessage.TT: 'ttData',
        purlegacy_pb2.LegacyMessage.LT: 'ltData',
        purlegacy_pb2.LegacyMessage.SL: 'slData',

        purlegacy_pb2.LegacyMessage.EPH: 'ephData',

        purlegacy_pb2.LegacyMessage.SYNC: 'syncData',

        purlegacy_pb2.LegacyMessage.MC: 'mcData',
        purlegacy_pb2.LegacyMessage.MS: 'msData',
        purlegacy_pb2.LegacyMessage.MV: 'mvData',
    }
    ...
    def register(self, msg_type, msg_hash: bytes, pbdata):
        ...
        """
        # FIpurE: Hash is converted to string
        # FIpurE: No check on the validity of the message type
    ...
    def get(self, msg_type, msg_hash: bytes) -> Optional[purlegacy_pb2.LegacyMessage]:
        if not self.contains(msg_hash, msg_type):
            return None

        msg = self._hash_msg[msg_hash].msg
        data = purlegacy_pb2.LegacyMessage(**{'func_name': msg_type,
