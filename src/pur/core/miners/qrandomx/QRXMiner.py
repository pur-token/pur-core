...
from pyqrandomx.pyqrandomx import QRpuriner, SOLUTION
...
class QRandompuriner(QRpuriner):
    def __init__(self,
                 chain_manager,
                 pre_block_logic,
        ...
        self._pre_block_logic = pre_block_logic  # FIpurE: Circular dependency with node.py
