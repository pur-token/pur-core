...
from pur.core.Miner import Miner
...
class POW(ConsensusMechanism):
    def __init__(self,
        ...
        self.p2p_factory = p2p_factory  # FIpurE: Decouple from p2pFactory. Comms vs node logic
        self.p2p_factory.pow = self  # FIpurE: Temporary hack to keep things working while refactoring
    ...
    def monitor_bk(self):
        # FIpurE: Too many magic numbers / timing constants
        # FIpurE: This is obsolete
    ...
    def start_download(self):
        # FIpurE: Why PoW is downloading blocks?
