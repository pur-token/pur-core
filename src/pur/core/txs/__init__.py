...
TYPENAME_PACKAGE = {
    'transfer': 'pur.core.txs',
    'coinbase': 'pur.core.txs',
    'latticePK': 'pur.core.txs',
    'message': 'pur.core.txs',
    'token': 'pur.core.txs',
    'transfer_token': 'pur.core.txs',
    'slave': 'pur.core.txs',

    'multi_sig_create': 'pur.core.txs.multisig',
    'multi_sig_spend': 'pur.core.txs.multisig',
    'multi_sig_vote': 'pur.core.txs.multisig',

    'proposal_vote': 'pur.core.txs.proposal',
}
