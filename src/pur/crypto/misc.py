...
from pypurlib.pypurlib import sha2_256, bin2hstr, hstr2bin, sha2_256_n  # noqa
...
def merkle_tx_hash(hashes):
    ...
    # FIpurE: Review and consider (CVE-2012-2459) and bitcoin source code
    """
    merkle tree root hash of tx from pool for next POW block
    :param hashes:
    :return:

    >>> bin2hstr(merkle_tx_hash([b'0', b'1']) ) # FIpurE: This input is not realistic
    ...
    '938db8c9f82c8cb58d3f3ef4fd250036a48d26a712753d2fde5abd03a85cabf4'
    >>> bin2hstr(merkle_tx_hash([b'0', b'938db8c9f82c8cb58d3f3ef4fd250036a48d26a712753d2fde5abd03a85cabf4']))  # FIpurE: This input is not realistic
