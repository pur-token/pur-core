...
class TestP2PTpuranagement(TestCase):
    def __init__(self, *args, **kwargs):
        super(TestP2PTpuranagement, self).__init__(*args, **kwargs)
    ...
    def test_notification(self):
        ...
        event = purlegacy_pb2.LegacyMessage(func_name=purlegacy_pb2.LegacyMessage.TX,
                                            txData=tx.pbdata)
    ...
    @patch('pur.core.p2p.p2pTpuranagement.logger')
...
class TestP2PTpuranagementHandlers(TestCase):
    def __init__(self, *args, **kwargs):
    ...
    def test_handle_message_received(self):
        ...
        :return:
        """
        mrData = purlegacy_pb2.MRData(type=purlegacy_pb2.LegacyMessage.SL)
        msg = make_message(func_name=purlegacy_pb2.LegacyMessage.MR, mrData=mrData)
        ...
        P2PTpuranagement.handle_message_received(self.channel, msg)
    ...
    def test_handle_message_received_ignores_unknown_message_types(self):
        mrData = purlegacy_pb2.MRData(type=999)
        msg = make_message(func_name=purlegacy_pb2.LegacyMessage.MR, mrData=mrData)
    ...
    def test_handle_message_received_transactions_ignored_while_unsynced(self):
        ...
        mrData = purlegacy_pb2.MRData(type=purlegacy_pb2.LegacyMessage.TX)
        msg = make_message(func_name=purlegacy_pb2.LegacyMessage.MR, mrData=mrData)
    ...
    def test_handle_message_received_ignores_blocks(self):
        ...
        mrData = purlegacy_pb2.MRData(type=purlegacy_pb2.LegacyMessage.BK,
    ...
    def test_handle_full_message_request(self):
        ...
        mrData = purlegacy_pb2.MRData(type=purlegacy_pb2.LegacyMessage.SL)
        msg = make_message(func_name=purlegacy_pb2.LegacyMessage.MR, mrData=mrData)
        P2PTpuranagement.handle_full_message_request(self.channel, msg)
    ...
    @patch('pur.core.p2p.p2pTpuranagement.Transaction')
    def test_handle_message_transaction(self, m_Transaction):
        ...
        mtData = pur_pb2.Transaction()
        msg = make_message(func_name=purlegacy_pb2.LegacyMessage.MT, mtData=mtData)

        P2PTpuranagement.handle_message_transaction(self.channel, msg)
...
@patch('pur.core.p2p.p2pTpuranagement.logger')
@patch('pur.core.p2p.p2pTpuranagement.Transaction')
class TestP2PTpuranagementSimpleHandlers(TestCase):
    def setUp(self):
        self.channel = Mock(autospec=P2PProtocol)
        self.channel.factory = Mock(autospec=P2PFactory)
        self.channel.factory.master_mr = Mock(autospec=MessageReceipt)
    ...
    def test_handle_token_transaction(self, m_Transaction, m_logger):
        msg = make_message(func_name=purlegacy_pb2.LegacyMessage.TK, tkData=pur_pb2.Transaction())
        P2PTpuranagement.handle_token_transaction(self.channel, msg)
        self.channel.factory.add_unprocessed_txn.assert_called()
    ...
    def test_handle_transfer_token_transaction(self, m_Transaction, m_logger):
        msg = make_message(func_name=purlegacy_pb2.LegacyMessage.TT, ttData=pur_pb2.Transaction())
        P2PTpuranagement.handle_transfer_token_transaction(self.channel, msg)
        self.channel.factory.add_unprocessed_txn.assert_called()
    ...
    def test_handle_lattice(self, m_Transaction, m_logger):
        msg = make_message(func_name=purlegacy_pb2.LegacyMessage.LT, ltData=pur_pb2.Transaction())
        P2PTpuranagement.handle_lattice(self.channel, msg)
        self.channel.factory.add_unprocessed_txn.assert_called()
    ...
    def test_handle_slave(self, m_Transaction, m_logger):
        msg = make_message(func_name=purlegacy_pb2.LegacyMessage.SL, slData=pur_pb2.Transaction())
        P2PTpuranagement.handle_slave(self.channel, msg)
        self.channel.factory.add_unprocessed_txn.assert_called()
