...
from pur.generated import purstateinfo_pb2
from pur.core import config
from pur.crypto.purss import purSS
from pur.crypto.QRandomX import QRandomX
...
from pur.core.DifficultyTracker import DifficultyTracker
...
from pur.core.txs.LatticeTransaction import LatticeTransaction
...
from pur.core.txs.multisig.MultiSigVote import MultiSigVote
from tests.misc.helper import get_alice_purss, get_bob_purss, set_default_balance_size, set_hard_fork_block_number, \
    set_pur_dir, replacement_getTime, get_some_address, gen_blocks
...
class TestChainManagerReal(TestCase):
    ...
    def test_load_twice(self):
        ...
        m_fork_state = Mock(autospec=purstateinfo_pb2.ForkState, initiator_headerhash=self.genesis_block.headerhash)
    ...
    @patch('pur.core.misc.ntp.getTime')
    def test_simple_add_block(self, time_mock):
        ...
        with patch.object(DifficultyTracker, 'get', return_value=ask_difficulty_tracker('2', config.dev)):
            ...
            # from pur.core.PoWValidator import PoWValidator
    ...
    def test_multi_output_transaction_add_block(self, time_mock):
        ...
        with patch.object(DifficultyTracker, 'get', return_value=ask_difficulty_tracker('2', config.dev)):
            ...
            random_purss = purSS.from_extended_seed(hstr2bin(extended_seed))

            transfer_transaction = TransferTransaction.create(addrs_to=[alice.address, random_purss.address],
            ...
            random_addr_state = self.chain_manager.get_optimized_address_state(random_purss.address)
    ...
    @patch("pur.core.DifficultyTracker.DifficultyTracker.get")
    def test_add_block(self, mock_difficulty_tracker_get):
        ...
        with patch.object(DifficultyTracker, 'get', return_value=ask_difficulty_tracker('2', config.dev)):
            ...
            with patch('pur.core.misc.ntp.getTime') as time_mock:
                time_mock.return_value = 1615270948  # Very high to get an easy difficulty
    ...
    def test_add_block2(self, time_mock):
        ...
        with patch.object(DifficultyTracker, 'get', return_value=ask_difficulty_tracker('2', config.dev)):
            ...
            multi_sig_create = MultiSigCreate.create(signatories=[alice_purss.address,
                                                                  bob_purss.address],
                                                     weights=[4, 6],
                                                     threshold=5,
                                                     fee=0,
                                                     purss_pk=alice_purss.pk)
            multi_sig_create.sign(alice_purss)
            ...
            transfer_transaction._data.nonce = 1
            transfer_transaction.sign(bob_purss)
            ...
            multi_sig_spend = MultiSigSpend.create(multi_sig_address=multi_sig_address,
                                                   addrs_to=[random_purss.address, alice_purss.address],
                                                   amounts=[10, 5],
                                                   expiry_block_number=100,
                                                   fee=0,
                                                   purss_pk=alice_purss.pk)
            multi_sig_spend.sign(alice_purss)
            ...
            multi_sig_vote1 = MultiSigVote.create(shared_key=multi_sig_spend.txhash,
                                                  ...
                                                  fee=0,
                                                  purss_pk=alice_purss.pk)
            multi_sig_vote1.sign(alice_purss)
            ...
            multi_sig_vote2 = MultiSigVote.create(shared_key=multi_sig_spend.txhash,
                                                  ...
                                                  fee=0,
                                                  purss_pk=bob_purss.pk)
            multi_sig_vote2.sign(bob_purss)
            ...
            bob_addr_state = self.chain_manager.get_optimized_address_state(bob_purss.address)
            alice_addr_state = self.chain_manager.get_optimized_address_state(alice_purss.address)
            random_addr_state = self.chain_manager.get_optimized_address_state(random_purss.address)
            multi_sig_address_state = MultiSigAddressState.get_multi_sig_address_state_by_address(self.state._db,
                                                                                                  multi_sig_address)
    ...
    def test_add_block4(self, time_mock):
        ...
        with patch.object(DifficultyTracker, 'get', return_value=ask_difficulty_tracker('2', config.dev)):
            ...
            block_1 = Block.create(dev_config=config.dev,
                                   ...
                                   miner_address=bob_purss.address,
                                   seed_height=seed_block.block_number,
                                   seed_hash=seed_block.headerhash)
    ...
    def test_add_block7(self, time_mock):
        ...
        with patch.object(DifficultyTracker, 'get', return_value=ask_difficulty_tracker('2', config.dev)):
            ...
            multi_sig_vote3 = MultiSigVote.create(shared_key=multi_sig_spend.txhash,
                                                  ...
                                                  fee=0,
                                                  purss_pk=alice_purss.pk)
            multi_sig_vote3.sign(alice_purss)
    ...
    def test_add_block9(self, time_mock):
        ...
        with patch.object(DifficultyTracker, 'get', return_value=ask_difficulty_tracker('2', config.dev)):
            ...
            multi_sig_vote2 = MultiSigVote.create(shared_key=multi_sig_spend.txhash,
                                                  ...
                                                  fee=0,
                                                  purss_pk=alice_purss.pk)
            multi_sig_vote2.sign(alice_purss)
    ...
    def test_add_block10(self, time_mock):
        ...
        with patch.object(DifficultyTracker, 'get', return_value=ask_difficulty_tracker('2', config.dev)):
            ...
            multi_sig_spend1 = MultiSigSpend.create(multi_sig_address=multi_sig_address,
                                                    ...
                                                    fee=0,
                                                    purss_pk=alice_purss.pk)
            multi_sig_spend1.sign(alice_purss)
            ...
            multi_sig_spend2 = MultiSigSpend.create(multi_sig_address=multi_sig_address,
                                                    ...
                                                    fee=0,
                                                    purss_pk=alice_purss.pk)
            multi_sig_spend2.sign(alice_purss)
            ...
            multi_sig_vote4 = MultiSigVote.create(shared_key=multi_sig_spend2.txhash,
                                                  ...
                                                  fee=0,
                                                  purss_pk=bob_purss.pk)
            multi_sig_vote4.sign(bob_purss)
    ...
    def test_add_block11(self, time_mock):
        ...
        with patch.object(DifficultyTracker, 'get', return_value=ask_difficulty_tracker('2', config.dev)):
            ...
            transfer_transaction1.sign(bob_purss)
            ...
            transfer_transaction2.sign(bob_purss)
            ...
            multi_sig_vote5 = MultiSigVote.create(shared_key=multi_sig_spend2.txhash,
                                                  ...
                                                  fee=0,
                                                  purss_pk=bob_purss.pk)
            multi_sig_vote5.sign(bob_purss)
            ...
            multi_sig_vote6 = MultiSigVote.create(shared_key=multi_sig_spend2.txhash,
                                                  ...
                                                  fee=0,
                                                  purss_pk=bob_purss.pk)
            multi_sig_vote6.sign(bob_purss)
    ...
    def test_add_block12(self, time_mock):
        ...
        with patch.object(DifficultyTracker, 'get', return_value=ask_difficulty_tracker('2', config.dev)):
            ...
            multi_sig_unvote1 = MultiSigVote.create(shared_key=multi_sig_spend.txhash,
                                                    ...
                                                    fee=0,
                                                    purss_pk=alice_purss.pk)
            multi_sig_unvote1.sign(alice_purss)
    ...
    def test_add_block13(self, time_mock):
        ...
        with patch.object(DifficultyTracker, 'get', return_value=ask_difficulty_tracker('2', config.dev)):
            ...
            random_purss1 = purSS.from_extended_seed(hstr2bin(extended_seed1))
            random_purss2 = purSS.from_extended_seed(hstr2bin(extended_seed2))
            alice_purss = get_alice_purss(4)
            bob_purss = get_bob_purss(4)
            slave_txn1 = SlaveTransaction.create(slave_pks=[random_purss1.pk, random_purss2.pk],
                                                 access_types=[0, 0],
                                                 fee=5,
                                                 purss_pk=alice_purss.pk)
            slave_txn1.sign(alice_purss)
            slave_txn1.pbdata.nonce = 1

            transfer_txn = TransferTransaction.create(addrs_to=[random_purss1.address],
                                                      amounts=[40 * int(config.dev.shor_per_quanta)],
                                                      message_data=None,
                                                      fee=1 * config.dev.shor_per_quanta,
                                                      purss_pk=random_purss2.pk,
                                                      master_addr=alice_purss.address)
            transfer_txn.sign(random_purss2)
            transfer_txn.pbdata.nonce = 1

            slave_txn2 = SlaveTransaction.create(slave_pks=[random_purss1.pk],
                                                 access_types=[0],
                                                 fee=5,
                                                 purss_pk=alice_purss.pk)
            slave_txn2.sign(alice_purss)
            ...
            bob_addr_state = self.chain_manager.get_optimized_address_state(bob_purss.address)
            alice_addr_state = self.chain_manager.get_optimized_address_state(alice_purss.address)
            random_addr_state1 = self.chain_manager.get_optimized_address_state(random_purss1.address)
            random_addr_state2 = self.chain_manager.get_optimized_address_state(random_purss2.address)
            ...
            slave_metadata = self.chain_manager.get_slave_pk_access_type(alice_addr_state.address, random_purss1.pk)
            self.assertEqual(slave_metadata.access_type, 0)

            slave_metadata = self.chain_manager.get_slave_pk_access_type(alice_addr_state.address, random_purss2.pk)
            self.assertEqual(slave_metadata.access_type, 0)
...
class TestChainManager(TestCase):
    ...
    @patch('pur.core.Block.Block', autospec=True)
    def test_fork_recovery_failed(self, mock_block):
        ...
        fork_state = purstateinfo_pb2.ForkState(
    ...
    @patch('pur.core.config')
    @patch('pur.core.ChainManager.ChainManager.re_org_limit', new_callable=PropertyMock)
    ...
    def test_get_block_datapoint(self):
        with set_pur_dir('no_data'):
            with State() as state:
                ...
                alice_purss = get_alice_purss()
                blocks = gen_blocks(20, state, alice_purss.address)
                for i in range(1, 20):
    ...
    def test_get_state_mainchain(self):
        with set_pur_dir('no_data'):
            with State() as state:
                chain_manager = ChainManager(state)
                alice_purss = get_alice_purss()
                alice_state = OptimizedAddressState.get_default(alice_purss.address)
