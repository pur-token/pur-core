...
from pur.core.misc.helper import parse_qaddress
...
from tests.misc.helper import get_alice_purss, get_bob_purss, replacement_getTime
...
class TestMiner(TestCase):
    ...
    def test_start_mining_works(self, m_getTime, m_logger):
        ...
        with patch('pur.core.miners.qryptonight7.CNv1Miner.CNv1Miner.start', spec=True) as m_start:
...
class TestMinerWithRealTransactionPool(TestCase):
    ...
    @patch('pur.core.Miner.Block.create')
