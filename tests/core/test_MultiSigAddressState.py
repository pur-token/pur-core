...
from tests.misc.helper import set_pur_dir, get_bob_purss, get_alice_purss, get_random_purss
...
class TestMultiSigAddressState(TestCase):
    ...
    def test_get_multi_sig_address_state_by_address(self):
        ...
        random_purss = get_random_purss()

        signatories = [alice_purss.address, bob_purss.address]
        weights = [20, 20]
        threshold = 21
        multi_sig_tx = MultiSigCreate.create(signatories,
                                             ...
                                             0,
                                             random_purss.pk)
        multi_sig_tx.sign(random_purss)
