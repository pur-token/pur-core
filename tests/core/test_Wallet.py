...
from pur.core.Wallet import Wallet, WalletEncryptionError, WalletVersionError, WalletDecryptionError
...
class TestWalletVer0(TestCase):
    ...
    def test_read_ver0(self):
        with set_pur_dir("wallet_ver0"):
            ...
            purss0 = wallet.get_purss_by_index(0)
            self.assertEqual('010400d9f1efe5b272e042dcc8ef690f0e90ca8b0b6edba0d26f81e7aff12a6754b21788169f7f',
                             bin2hstr(purss0.address))

            purss0b = wallet.get_purss_by_address(purss0.address)
            self.assertEqual('010400d9f1efe5b272e042dcc8ef690f0e90ca8b0b6edba0d26f81e7aff12a6754b21788169f7f',
                             bin2hstr(purss0b.address))

    def test_read_secure_ver0(self):
        with set_pur_dir("wallet_secure_ver0"):
            wallet = Wallet()
            self.assertEqual(1, len(wallet.address_items))
            self.assertEqual(wallet.version, 0)
    ...
    def test_read_wallet_secure_ver0_saves_wallet_ver1_encrypted(self):
        with set_pur_dir("wallet_secure_ver0"):
            ...
            purss0 = wallet_reloaded.get_purss_by_index(0)
            self.assertEqual('010400d9f1efe5b272e042dcc8ef690f0e90ca8b0b6edba0d26f81e7aff12a6754b21788169f7f',
                             bin2hstr(purss0.address))

            purss0b = wallet_reloaded.get_purss_by_address(purss0.address)
            self.assertEqual('010400d9f1efe5b272e042dcc8ef690f0e90ca8b0b6edba0d26f81e7aff12a6754b21788169f7f',
                             bin2hstr(purss0b.address))
...
class TestWallet(TestCase):
    ...
    def test_read_secure(self):
        with set_pur_dir("wallet_secure_ver1"):
            wallet = Wallet()
            self.assertEqual(1, len(wallet.address_items))
            self.assertEqual(wallet.version, 1)
    ...
    def test_create(self):
        with set_pur_dir("no_data"):
            ...
            purss1 = wallet.add_new_address(4)
            self.assertEqual(1, len(wallet.address_items))

            purss2 = wallet.get_purss_by_index(0)

            self.assertEqual(purss1.address, purss2.address)
            self.assertEqual(purss1.mnemonic, purss2.mnemonic)
    ...
    def test_create_custom_hash_function(self):
        with set_pur_dir("no_data"):
            wallet = Wallet()
            purss = wallet.add_new_address(height=4, hash_function="sha2_256")
