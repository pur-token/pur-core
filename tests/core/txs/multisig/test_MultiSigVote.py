...
from tests.misc.helper import get_alice_purss, get_bob_purss, set_pur_dir, set_hard_fork_block_number
...
class TestMultiSigVote(TestCase):
    def __init__(self, *args, **kwargs):
        ...
        self.random = get_alice_purss(4)
        self.random_signer = get_bob_purss(4)
