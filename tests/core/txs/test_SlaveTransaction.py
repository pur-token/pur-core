...
from tests.misc.helper import get_alice_purss, get_slave_purss, get_bob_purss, set_pur_dir
...
class TestSlaveTransaction(TestCase):
    ...
    def test_validate_extended(self, m_validate_slave, m_logger):
        ...
        # fee = -1
        with patch('pur.core.txs.SlaveTransaction.SlaveTransaction.fee', new_callable=PropertyMock) as m_fee:
