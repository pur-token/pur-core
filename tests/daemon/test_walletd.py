...
from pur.daemon.helper.DaemonHelper import WalletDecryptionError
from pur.core.misc import logger
from tests.misc.helper import set_pur_dir, get_alice_purss, get_bob_purss
...
class TestWalletD(TestCase):
    ...
    def test_get_unused_ots_index(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetOTS = Mock(
                return_value=pur_pb2.GetOTSResp(next_unused_ots_index=10, unused_ots_index_found=True))
            ...
            walletd._public_stub.GetOTS = Mock(
                return_value=pur_pb2.GetOTSResp(next_unused_ots_index=10, unused_ots_index_found=False))
    ...
    def test_get_wallet_index_purss(self):
        with set_pur_dir("wallet_ver1"):
            walletd = WalletD()
            walletd._public_stub.PushTransaction = Mock(
                return_value=pur_pb2.PushTransactionResp(error_code=pur_pb2.PushTransactionResp.SUBMITTED))
            ...
            index, purss = walletd._get_wallet_index_purss(qaddress, 0)
            self.assertEqual(index, 0)
            self.assertEqual(purss.qaddress, qaddress)
    ...
    def test_sign_and_push_transaction(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd.sign_and_push_transaction(tx, alice_purss, 0, enable_save=False)

            walletd._public_stub.PushTransaction = Mock(
                return_value=pur_pb2.PushTransactionResp(error_code=pur_pb2.PushTransactionResp.UNKNOWN))
        ...
        with set_pur_dir("wallet_ver1"):
            ...
            with self.assertRaises(Exception):
                walletd.relay_transfer_txn(qaddresses_to=qaddresses_to,
                                           ...
                                           fee=100000000,
                                           master_qaddress=None,
                                           signer_address=alice_purss.qaddress,
                                           ots_index=0)
        ...
        with set_pur_dir("wallet_ver1"):
            ...
            with self.assertRaises(Exception):
                walletd.relay_transfer_txn_by_slave(qaddresses_to=qaddresses_to,
                                                    amounts=amounts,
                                                    fee=100000000,
                                                    master_qaddress=alice_purss.qaddress)
    ...
    def test_relay_message_txn(self):
        with set_pur_dir("wallet_ver1"):
            ...
            tx = walletd.relay_message_txn(message='Hello pur!',
                                           fee=100000000,
                                           master_qaddress=None,
                                           signer_address=qaddress,
                                           ots_index=0)
    ...
    def test_relay_message_txn_by_slave(self):
        with set_pur_dir("wallet_ver1"):
            ...
            tx = walletd.relay_message_txn_by_slave(message='Hello pur!',
                                                    fee=100000000,
                                                    master_qaddress=qaddress)
            self.assertIsNotNone(tx)
    ...
    def test_relay_message_txn2(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd.lock_wallet()
            with self.assertRaises(ValueError):
                walletd.relay_message_txn(message='Hello pur!',
                                          fee=100000000,
                                          master_qaddress=None,
                                          signer_address=qaddress,
                                          ots_index=0)
    ...
    def test_relay_message_txn2_by_slave(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd.lock_wallet()
            with self.assertRaises(ValueError):
                walletd.relay_message_txn_by_slave(message='Hello pur!',
                                                   fee=100000000,
                                                   master_qaddress=qaddress)
    ...
    def test_relay_token_txn(self):
        with set_pur_dir("wallet_ver1"):
            ...
            tx = walletd.relay_token_txn(symbol='pur',
                                         name='Quantum Resistant Ledger',
                                         owner_qaddress=alice_purss.qaddress,
                                         decimals=5,
    ...
    def test_relay_token_txn_by_slave(self):
        with set_pur_dir("wallet_ver1"):
            ...
            tx = walletd.relay_token_txn_by_slave(symbol='pur',
                                                  name='Quantum Resistant Ledger',
                                                  owner_qaddress=alice_purss.qaddress,
                                                  decimals=5,
                                                  qaddresses=qaddresses,
    ...
    def test_relay_token_txn2(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd.lock_wallet()
            with self.assertRaises(ValueError):
                walletd.relay_token_txn(symbol='pur',
                                        name='Quantum Resistant Ledger',
                                        owner_qaddress=alice_purss.qaddress,
                                        decimals=5,
                                        qaddresses=qaddresses,
    ...
    def test_relay_token_txn2_by_slave(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd.lock_wallet()
            with self.assertRaises(ValueError):
                walletd.relay_token_txn_by_slave(symbol='pur',
                                                 name='Quantum Resistant Ledger',
                                                 owner_qaddress=alice_purss.qaddress,
                                                 decimals=5,
                                                 qaddresses=qaddresses,
    ...
    def test_get_mini_transactions_by_address(self):
        with set_pur_dir("wallet_ver1"):
            ...
            mini_transactions, balance = walletd.get_mini_transactions_by_address(
                qaddress=get_alice_purss(4).qaddress,
                item_per_page=10,
                page_number=1
            )
    ...
    def test_get_transaction(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetTransaction = Mock(
                return_value=pur_pb2.GetTransactionResp(tx=tx,
                                                        confirmations=10,
                                                        block_number=5,
