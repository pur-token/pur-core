...
from pur.daemon.walletd import WalletD
from pur.generated import purwallet_pb2, pur_pb2
from pur.services.WalletAPIService import WalletAPIService
from tests.misc.helper import get_alice_purss, get_bob_purss, set_pur_dir, replacement_getTime
...
class TestWalletAPI(TestCase):
    ...
    def test_addNewAddress(self):
        with set_pur_dir("wallet_ver1"):
            walletd = WalletD()
            service = WalletAPIService(walletd)
            resp = service.AddNewAddress(purwallet_pb2.AddNewAddressReq(), context=None)
    ...
    def test_addNewAddressWithSlaves(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd._public_stub.PushTransaction = Mock(
                return_value=pur_pb2.PushTransactionResp(error_code=pur_pb2.PushTransactionResp.SUBMITTED))

            service = WalletAPIService(walletd)
            resp = service.AddNewAddressWithSlaves(purwallet_pb2.AddNewAddressWithSlavesReq(), context=None)
            self.assertEqual(resp.code, 0)
            self.assertEqual(resp.address[0], 'Q')
    ...
    def test_addAddressFromSeed(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd = WalletD()
            service = WalletAPIService(walletd)
            resp = service.AddAddressFromSeed(purwallet_pb2.AddAddressFromSeedReq(seed=hex_seed), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_addAddressFromSeed2(self):
        with set_pur_dir("wallet_ver1"):
            walletd = WalletD()
            service = WalletAPIService(walletd)
            resp = service.AddAddressFromSeed(purwallet_pb2.AddAddressFromSeedReq(seed=self.mnemonic), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_listAddresses(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.ListAddresses(purwallet_pb2.ListAddressesReq(), context=None)
    ...
    def test_removeAddress(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.RemoveAddress(purwallet_pb2.RemoveAddressReq(address=address), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_isValidAddress(self):
        with set_pur_dir("wallet_ver1"):
            ...
            qaddress = "Q010400ff39df1ba4d1d5b8753e6d04c51c34b95b01fc3650c10ca7b296a18bdc105412c59d0b3b"
            resp = service.IsValidAddress(purwallet_pb2.ValidAddressReq(address=qaddress), context=None)
    ...
    def test_getRecoverySeeds(self):
        with set_pur_dir("wallet_ver1"):
            ...
            service.AddAddressFromSeed(purwallet_pb2.AddAddressFromSeedReq(seed=self.mnemonic), context=None)
            resp = service.GetRecoverySeeds(purwallet_pb2.GetRecoverySeedsReq(address=self.qaddress), context=None)
    ...
    def test_getWalletInfo(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.GetWalletInfo(purwallet_pb2.GetWalletInfoReq(), context=None)
    ...
    def test_relayTransferTxn(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetAddressState = Mock(
                return_value=pur_pb2.GetAddressStateResp(state=addr_state.pbdata))
            walletd._public_stub.IsSlave = Mock(
                return_value=pur_pb2.IsSlaveResp(result=True))
            walletd._public_stub.GetOTS = Mock(
                return_value=pur_pb2.GetOTSResp(next_unused_ots_index=0,
                                                unused_ots_index_found=True))

            alice_purss = get_alice_purss(4)
            bob_purss = get_bob_purss(4)
            qaddresses_to = [alice_purss.qaddress, bob_purss.qaddress]
            amounts = [1000000000, 1000000000]

            walletd._public_stub.PushTransaction = Mock(
                return_value=pur_pb2.PushTransactionResp(error_code=pur_pb2.PushTransactionResp.SUBMITTED))

            resp = service.RelayTransferTxn(purwallet_pb2.RelayTransferTxnReq(addresses_to=qaddresses_to,
                                                                              amounts=amounts,
                                                                              fee=100000000,
                                                                              master_address=None,
    ...
    def test_relayTransferTxnBySlave(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.RelayTransferTxnBySlave(
                purwallet_pb2.RelayTransferTxnBySlaveReq(addresses_to=qaddresses_to,
                                                         amounts=amounts,
                                                         fee=100000000,
    ...
    def test_relayMessageTxn(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.RelayMessageTxn(purwallet_pb2.RelayMessageTxnReq(message=b'Hello pur!',
                                                                            fee=100000000,
                                                                            master_address=None,
                                                                            signer_address=qaddress,
                                                                            ots_index=0), context=None)
    ...
    def test_relayMessageTxnBySlave(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.RelayMessageTxnBySlave(
                purwallet_pb2.RelayMessageTxnReq(message=b'Hello pur!',
                                                 fee=100000000,
                                                 master_address=qaddress), context=None)
    ...
    def test_relayTokenTxn(self):
        with set_pur_dir("wallet_ver1"):
            ...
            alice_purss = get_alice_purss(4)
            bob_purss = get_bob_purss(4)
            qaddresses = [alice_purss.qaddress, bob_purss.qaddress]
            amounts = [1000000000, 1000000000]

            walletd._public_stub.PushTransaction = Mock(
                return_value=pur_pb2.PushTransactionResp(error_code=pur_pb2.PushTransactionResp.SUBMITTED))

            resp = service.RelayTokenTxn(purwallet_pb2.RelayTokenTxnReq(symbol=b'pur',
                                                                        name=b'Quantum Resistant Ledger',
                                                                        owner=alice_purss.qaddress,
                                                                        decimals=5,
    ...
    def test_relayTokenTxnBySlave(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.RelayTokenTxnBySlave(
                purwallet_pb2.RelayTokenTxnBySlaveReq(symbol=b'pur',
                                                      name=b'Quantum Resistant Ledger',
                                                      owner=alice_purss.qaddress,
                                                      decimals=5,
                                                      addresses=qaddresses,
    ...
    def test_relayTransferTokenTxn(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.RelayTransferTokenTxn(purwallet_pb2.RelayTransferTokenTxnReq(addresses_to=qaddresses_to,
                                                                                        amounts=amounts,
                                                                                        token_txhash='',
                                                                                        fee=100000000,
                                                                                        master_address=None,
    ...
    def test_relayTransferTokenTxnBySlave(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.RelayTransferTokenTxnBySlave(
                purwallet_pb2.RelayTransferTokenTxnBySlaveReq(addresses_to=qaddresses_to,
                                                              amounts=amounts,
                                                              token_txhash='',
                                                              fee=100000000,
                                                              master_address=qaddress), context=None)
    ...
    def test_relaySlaveTxn(self):
        with set_pur_dir("wallet_ver1"):
            ...
            alice_purss = get_alice_purss(4)
            slave_pks = [alice_purss.pk]
            access_types = [0]

            walletd._public_stub.PushTransaction = Mock(
                return_value=pur_pb2.PushTransactionResp(error_code=pur_pb2.PushTransactionResp.SUBMITTED))

            resp = service.RelaySlaveTxn(purwallet_pb2.RelaySlaveTxnReq(slave_pks=slave_pks,
    ...
    def test_relaySlaveTxnBySlave(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.RelaySlaveTxnBySlave(
                purwallet_pb2.RelaySlaveTxnBySlaveReq(slave_pks=slave_pks,
                                                      access_types=access_types,
                                                      fee=100000000,
                                                      master_address=qaddress), context=None)
    ...
    def test_encryptWallet(self):
        with set_pur_dir("wallet_ver1"):
            ...
            service.AddNewAddress(purwallet_pb2.AddNewAddressReq(), context=None)

            resp = service.EncryptWallet(purwallet_pb2.EncryptWalletReq(), context=None)
            self.assertEqual(resp.code, 1)

            resp = service.EncryptWallet(purwallet_pb2.EncryptWalletReq(passphrase=self.passphrase), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_lockWallet(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.UnlockWallet(purwallet_pb2.UnlockWalletReq(passphrase=self.passphrase), context=None)
            self.assertEqual(resp.code, 0)

            resp = service.ListAddresses(purwallet_pb2.ListAddressesReq(), context=None)
            self.assertEqual(resp.code, 0)

            resp = service.LockWallet(purwallet_pb2.LockWalletReq(), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_unlockWallet(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.UnlockWallet(purwallet_pb2.UnlockWalletReq(), context=None)
            self.assertEqual(resp.code, 1)

            resp = service.UnlockWallet(purwallet_pb2.UnlockWalletReq(passphrase="wrong"), context=None)
            self.assertEqual(resp.code, 1)
    ...
    def test_changePassphrase(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.ChangePassphrase(
                purwallet_pb2.ChangePassphraseReq(oldPassphrase=self.passphrase,
            ...
            resp = service.UnlockWallet(purwallet_pb2.UnlockWalletReq(passphrase=new_passphrase), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_getTransactionsByAddress(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetMiniTransactionsByAddress = Mock(
                return_value=pur_pb2.GetMiniTransactionsByAddressResp(mini_transactions=[],
                                                                      balance=0))

            resp = service.GetTransactionsByAddress(
                purwallet_pb2.TransactionsByAddressReq(address=get_alice_purss(4).qaddress), context=None)
    ...
    def test_getTransaction(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetTransaction = Mock(
                return_value=pur_pb2.GetTransactionResp(tx=tx, confirmations=10))

            resp = service.GetTransaction(purwallet_pb2.TransactionReq(tx_hash=tx.transaction_hash), context=None)
    ...
    def test_getBalance(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetBalance = Mock(
                return_value=pur_pb2.GetBalanceResp(balance=1000))

            resp = service.GetBalance(purwallet_pb2.BalanceReq(address=self.qaddress), context=None)
    ...
    def test_getTotalBalance(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetTotalBalance = Mock(
                return_value=pur_pb2.GetTotalBalanceResp(balance=6000))

            resp = service.GetTotalBalance(purwallet_pb2.TotalBalanceReq(), context=None)
    ...
    def test_getOTS(self):
        with set_pur_dir("wallet_ver1"):
            ...
            ots_bitfield_by_page = pur_pb2.OTSBitfieldByPage(ots_bitfield=[b'\x00'] * 10,
                                                             page_number=1)
            walletd._public_stub.GetOTS = Mock(
                return_value=pur_pb2.GetOTSResp(ots_bitfield_by_page=[ots_bitfield_by_page],
                                                next_unused_ots_index=1,
                                                unused_ots_index_found=True))

            resp = service.GetOTS(purwallet_pb2.OTSReq(address=self.qaddress), context=None)
            self.assertEqual(resp.code, 0)
    ...
    def test_getHeight(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetHeight = Mock(
                return_value=pur_pb2.GetHeightResp(height=1001))

            resp = service.GetHeight(purwallet_pb2.HeightReq(), context=None)
    ...
    def test_getBlock(self):
        with set_pur_dir("wallet_ver1"):
            ...
            walletd._public_stub.GetBlock = Mock(
                return_value=pur_pb2.GetBlockResp(block=block))

            resp = service.GetBlock(purwallet_pb2.BlockReq(header_hash=b'001122'), context=None)
    ...
    def test_getBlockByNumber(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.GetBlockByNumber(purwallet_pb2.BlockByNumberReq(block_number=1), context=None)
    ...
    def test_getAddressFromPK(self):
        with set_pur_dir("wallet_ver1"):
            ...
            resp = service.GetAddressFromPK(purwallet_pb2.AddressFromPKReq(pk=pk), context=None)
    ...
    def test_getNodeInfo(self):
        with set_pur_dir("wallet_ver1"):
            ...
            node_info = pur_pb2.NodeInfo(version=version,
            ...
            walletd._public_stub.GetNodeState = Mock(
                return_value=pur_pb2.GetNodeStateResp(info=node_info))

            resp = service.GetNodeInfo(purwallet_pb2.NodeInfoReq(), context=None)
